...
- Added a Windows Registry `ExtensionInstallAllowlist` injector to the PowerShell installer that tricks Chromium into thinking the System Administrator mandated the extension. 
